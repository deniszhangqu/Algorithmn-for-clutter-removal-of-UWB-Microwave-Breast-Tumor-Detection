...
Ansatzlist={'UWBAverageSubtraktion', 'UWBSVD_Verma','UWBSVD_Elahi', 'UWBEntropie'};

for i=1:1:1
    Messungname=datenlist{i};
    
    RemovelAnsatz='UWBWienerfilter';  %  'UWBAverageSubtraktion'/'UWBSVD_Verma'/'UWBSVD_Elahi'/'UWBEntropie'
    
    [Rohsignal,Idealsignal,Gefiltsignal,PPRR,CM,MSE]=Mainprocessor(Messungname,RemovelAnsatz,Path_Meas,Path_Gold);
